...
function buildMiddleAgedMan() {
  ...
  group.userData.dialogue = [
    '業績はどうかね？',
    '最近、若い社員がよく頑張っているようじゃのう。',
    '次の四半期はもっと攻めていこう。',
    'コーヒーでも一杯どうかね？',
    'わしの若い頃は残業なんて当たり前じゃった。',
    'このオフィスの空気、なかなか良いのう。',
    '顧客満足度を第一に考えてくれたまえ。',
    '会議室、午後3時から押さえておいてくれ。',
    '報告書は明日の朝までに頼むぞ。',
    ...
    '株主総会の準備は進んでおるかね？',
    '福利厚生を充実させたいと思っておる。',
    '退社前に電気の消し忘れがないか見てくれたまえ。',
    'このデスクの書類、早めに目を通してくれ。',
    '君たちの頑張りには感謝しておるよ。',
    'わしもそろそろ会長になる頃合いかのう。',
    '取引先との会食、明日の夜空けておきたまえ。',
    '観葉植物、誰が水をやっているんじゃろうな。',
    'この部屋、集中して仕事できそうで良いな。',
    '今日の決裁書類、わしの机に置いておいてくれ。',
    'モニターが大きいのは羨ましいのう。わしの部屋のも更新せねば。',
  ];
  return group;
}
...
function buildYoungMan() {
  ...
  group.userData.dialogue = [
    ...
    'この企画書、どう思います？',
    '昨日の残業で今日ちょっと眠いんすよ…',
    'Slackの返信、まだできてないんだよな…',
    '先輩、コーヒー淹れましょうか？',
    '会議、また長引きそうですね…',
    'このモニター広いわ〜、作業捗る！',
    '金曜日、飲みに行きません？',
    '納期ヤバいっすよ、手伝ってもらえないっすか？',
    'この部屋、静かで作業しやすいですね。',
    '経費精算、忘れてた…今日中に出さなきゃ',
    '社長、今機嫌よさそうでよかった…',
    '最近テレワークが続いてて、久々の出社っす',
    '昼飯、何食べに行きます？',
    'この会社の空調、効きすぎじゃないすか？',
    '新しいプロジェクト、誰がリーダーになるんですかね？',
    '先月の売上、目標達成したらしいですよ！',
    'この椅子、座り心地いいっすね…社長のだったりします？',
    '社長に話しかけられるとマジで緊張するんすよ〜',
    '今日の定時ダッシュ、成功させましょう！',
  ];
  return group;
}
...
function buildMiddleAgedManSit() {
  ...
  group.userData.dialogue = [
    'やれやれ、ちょっと一服じゃ。',
    'このチェア、座り心地が意外と良いのう。経費で買って正解じゃった。',
    '業績はどうかね？',
    '最近、若い社員がよく頑張っているようじゃのう。',
    '次の四半期はもっと攻めていこう。',
    'コーヒーでも一杯頼む。',
    ...
    '株主総会の準備は進んでおるかね？',
    '福利厚生を充実させたいと思っておる。',
    'この観葉植物、誰が水をやっているんじゃろうな。',
    '座りっぱなしは良くないが、このチェアは腰に優しいのう。',
    'お茶でも淹れてくれんか？',
    '君たちの頑張りには感謝しておるよ。',
    'わしもそろそろ会長になる頃合いかのう。',
    '取引先との会食、明日の夜空けておきたまえ。',
